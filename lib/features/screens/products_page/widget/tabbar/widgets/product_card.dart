        ...
        children: [
          SizedBox(
           ...
           Column(
             crossAxisAlignment: CrossAxisAlignment.start,
             children: [
               Text(product.title, style: AppStyle.light.copyWith(fontSize: text24(context)),),
               8.getH(context),
               SizedBox(
                 ...
                 child: Text(
                   ...
                   maxLines: 2,
                   "Shortbread, chocolate turtle cookies, and red velvet.", style: AppStyle.normal,),
               ),
               Row(
                 mainAxisSize: MainAxisSize.max,
                 // mainAxisAlignment: MainAxisAlignment.spaceBetween,
                 children: [
                   Text("\$\$ • Chinese", style: AppStyle.normal.copyWith(fontSize: text14(context)),),
                   const SizedBox(width: 20,),
                   Text('AUD ${product.price}', style: AppStyle.normal.copyWith(color: AppColors.primary, fontSize: text16(context)),)
                 ],
               )
             ],
           )
